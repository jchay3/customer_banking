...
def main():
    ...
    savings_maturity = int(input("Enter the number of months you will leave the balance in for: "))
    ...
    cd_maturity = int(input("How many months are your requesting for the maturity of this account: "))
